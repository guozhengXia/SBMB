package com.honor.sbmb.front.controller.user;
...
public class UserController {
    ...
    public Object login(HttpServletResponse response, @RequestBody UserModel userModel) {
        ...
        UserModel managerModel1 = userService.login(response, userModel);
